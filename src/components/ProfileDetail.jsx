...
import { ref, uploadString, getDownloadURL } from 'firebase/storage'; // Changé uploadBytes par uploadString pour le support mobile Web
...
const ProfileDetail = ({ userData }) => {
  ...
  // FONCTION D'UPLOAD DE PHOTO DE PROFIL (MODIFIÉE POUR WEB MOBILE)
  const handlePhotoChange = async (e) => {
    ...
    reader.readAsDataURL(file); // Lecture du fichier en Base64 pour éviter les problèmes de stream sur mobile
    ...
    reader.onerror = (error) => {
      console.error("Erreur lecture FileReader:", error);
      setUploadingPhoto(false);
    };
  };
